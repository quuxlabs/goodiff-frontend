...
<div id="mainnav" class="nav"><ul><li class="first"><a href="/">Home</a></li><li><a href="<?cs var:trac.href.wiki ?>/GooDiff">About</a></li><li><a href="/changeset/28">Example</a></li><li><a href="/log">List of Changes</a></li><li><a href="<?cs var:trac.href.browser ?>">Browse Archive</a></li><li><a href="<?cs var:trac.href.wiki ?>/RssFeeds">RSS Feeds</a></li><li class="last"><a href="<?cs var:trac.href.wiki ?>/FAQ">FAQ</a></li></ul></div>
<div id="main">
